...
var MapboxGeocoder = class extends HTMLScopedElement {
  ...
  search(text) {
    this.value = text;
    __privateGet2(this, _onHandleInput3).call(this, new MapboxHTMLEvent("input", text));
  }
  bindMap(map) {
    if (__privateGet2(this, _map2)) {
...
var AddressAutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    __privateAdd2(this, _onHandleInput4, (e) => {
      ...
      toggleAutocompletion(__privateGet2(this, _input4), __privateGet2(this, _initialAutocompleteValue2), enableBrowserAutocomplete);
      if ((value == null ? void 0 : value.length) <= 2) {
        this.listbox.handleSuggest(null);
        return;
      }
      __privateGet2(this, _session4).suggest(value, this.options);
    });
    __privateAdd2(this, _onHandleSelect4, (e) => {
      const suggestion = e.detail;
      if (e.detail.accuracy !== "street") {
        toggleAutocompletion(__privateGet2(this, _input4), __privateGet2(this, _initialAutocompleteValue2), true);
        __privateGet2(this, _session4).retrieve(suggestion, this.options);
      } else {
        handleStreetSelection(__privateGet2(this, _input4), __privateGet2(this, _initialAutocompleteValue2), suggestion);
      }
    });
    __privateAdd2(this, _onHandleBlur4, () => {
      toggleAutocompletion(__privateGet2(this, _input4), __privateGet2(this, _initialAutocompleteValue2), true);
      __privateGet2(this, _session4).abort();
    });
    __privateAdd2(this, _onHandleFocus2, () => {
      var _a;
      const enableBrowserAutocomplete = __privateGet2(this, _collection).browserAutofillEnabled === true && ((_a = __privateGet2(this, _input4).value) == null ? void 0 : _a.length) <= 2;
      toggleAutocompletion(__privateGet2(this, _input4), __privateGet2(this, _initialAutocompleteValue2), enableBrowserAutocomplete);
    });
    __privateAdd2(this, _handleSuggest4, (result) => {
      const filteredSuggestions = (result == null ? void 0 : result.suggestions) ? distinctExactStreetResults(result.suggestions) : null;
      this.listbox.handleSuggest(filteredSuggestions);
      const event = new MapboxHTMLEvent("suggest", result);
      Object.defineProperty(event, "target", { value: __privateGet2(this, _input4) });
      __privateGet2(this, _collection).fire("suggest", event);
    });
    __privateAdd2(this, _handleSuggestError4, (error) => {
    ...
    __privateAdd2(this, _handleRetrieve4, (result) => {
      ...
      fillFormWithFeature(featureCollection.features[0], __privateGet2(this, _input4));
    });
    __privateSet2(this, _input4, input);
    __privateSet2(this, _collection, collection);
    __privateSet2(this, _session4, new SearchSession(autofillRef));
    __privateGet2(this, _session4).sessionToken = config.autofillSessionToken;
    this.listbox.input = __privateGet2(this, _input4);
    this.listbox.autofillHost = this;
    this.listbox.searchService = 0;
    this.listbox.addEventListener("input", __privateGet2(this, _onHandleInput4));
    this.listbox.addEventListener("select", __privateGet2(this, _onHandleSelect4));
    this.listbox.addEventListener("blur", __privateGet2(this, _onHandleBlur4));
    this.listbox.addEventListener("focus", __privateGet2(this, _onHandleFocus2));
    __privateGet2(this, _session4).addEventListener("suggest", __privateGet2(this, _handleSuggest4));
    __privateGet2(this, _session4).addEventListener("suggesterror", __privateGet2(this, _handleSuggestError4));
    __privateGet2(this, _session4).addEventListener("retrieve", __privateGet2(this, _handleRetrieve4));
  ...
  get input() {
    return __privateGet2(this, _input4);
  }
  remove() {
    this.listbox.remove();
    this.listbox.removeEventListener("input", __privateGet2(this, _onHandleInput4));
    this.listbox.removeEventListener("select", __privateGet2(this, _onHandleSelect4));
    this.listbox.removeEventListener("blur", __privateGet2(this, _onHandleBlur4));
    this.listbox.removeEventListener("focus", __privateGet2(this, _onHandleFocus2));
    __privateGet2(this, _session4).removeEventListener("suggest", __privateGet2(this, _handleSuggest4));
    __privateGet2(this, _session4).removeEventListener("suggesterror", __privateGet2(this, _handleSuggestError4));
    __privateGet2(this, _session4).removeEventListener("retrieve", __privateGet2(this, _handleRetrieve4));
  }
  simulateRetrieve(feature) {
    const input = __privateGet2(this, _input4);
    if (input) {
      input.dataset["mapboxSuccess"] = "true";
    }
    ...
    __privateGet2(this, _handleRetrieve4).call(this, simResult);
  }
};

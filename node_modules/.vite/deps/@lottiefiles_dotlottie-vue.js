...
var r0 = (() => {
  ...
  return function(i = {}) {
      ...
      for (a = ""; t < r; ) {
        ...
        if (o & 128) {
          ...
          if ((o & 224) == 192)
            ...
            var h3 = e[t++] & 63;
            o = (o & 240) == 224 ? (o & 15) << 12 | u << 6 | h3 : (o & 7) << 18 | u << 12 | h3 << 6 | e[t++] & 63, 65536 > o ? a += String.fromCharCode(o) : (o -= 65536, a += String.fromCharCode(55296 | o >> 10, 56320 | o & 1023));
          }
        } else
    ...
    var A2 = 0, p1 = (e, t, r) => {
      ...
      if (0 < r) {
        ...
        for (var o = 0; o < e.length; ++o) {
          ...
          if (55296 <= u && 57343 >= u) {
            var h3 = e.charCodeAt(++o);
            u = 65536 + ((u & 1023) << 10) | h3 & 1023;
          }
          if (127 >= u) {
            if (t >= r)
              break;
    ...
    function L3(e, t, r, a, o, u, h3, l) {
      this.name = e, this.constructor = t, this.Ga = r, this.Ea = a, this.Aa = o, this.Wa = u, this.Ka = h3, this.Ua = l, this.cb = [];
    }
    var K1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Ka)
    ...
    function g1(e, t, r, a, o, u, h3, l, p, v, f) {
      this.name = e, this.va = t, this.Na = r, this.La = a, this.Ma = o, this.bb = u, this.ib = h3, this.Sa = l, this.Oa = p, this.eb = v, this.Ea = f, o || t.Aa !== void 0 ? this.toWireType = M3 : (this.toWireType = a ? C3 : E3, this.Da = null);
    }
    var W2 = (e, t, r) => {
      if (!d.hasOwnProperty(e))
    ...
    function X1(e, t, r, a, o) {
      ...
      var h3 = t[1] !== null && r !== null, l = S3(t), p = t[0].name !== "void", v = u - 2, f = Array(v), w = [], L = [];
      return _1(e, function(...U) {
        if (L.length = 0, w.length = h3 ? 2 : 1, w[0] = o, h3) {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var V3 = { c: (e, t, r, a) => P1(`Assertion failed: ${e ? c1(x, e) : ""}, at: ` + [t ? t ? c1(x, t) : "" : "unknown filename", r, a ? a ? c1(x, a) : "" : "unknown function"]), m: (e, t, r) => {
      ...
      var t = I1[e];
      delete I1[e];
      var r = t.Oa, a = t.Ea, o = t.Ra, u = o.map((h3) => h3.$a).concat(o.map((h3) => h3.gb));
      Q([e], u, (h3) => {
        var l = {};
        return o.forEach((p, v) => {
          var f = h3[v], w = p.Ya, L = p.Za, U = h3[v + o.length], I = p.fb, T = p.hb;
    ...
    }, r: (e, t, r, a, o, u, h3, l, p, v, f, w, L) => {
      f = D(f), u = z(o, u), l && (l = z(h3, l)), v && (v = z(p, v)), L = z(w, L);
      var U = b3(f);
      q1(U, function() {
      ...
      o = z(a, o), Q([], [e], (l) => {
        ...
        return l.va.Fa[t - 1] = () => {
          F1(`Cannot construct ${l.name} due to unbound types`, h3);
        }, Q([], h3, (v) => (v.splice(1, 0, null), l.va.Fa[t - 1] = X1(p, v, null, o, u), [])), [];
      });
    }, f: (e, t, r, a, o, u, h3, l) => {
      var p = Y1(r, a);
      t = D(t), t = B2(t), u = z(o, u), Q([], [e], (v) => {
        ...
        var L = v.va.Ga, U = L[t];
        return U === void 0 || U.ya === void 0 && U.className !== v.name && U.Ha === r - 2 ? (f.Ha = r - 2, f.className = v.name, L[t] = f) : (z2(L, t, w), L[t].ya[r - 2] = f), Q([], p, (I) => (I = X1(w, I, v, u, h3), L[t].ya === void 0 ? (I.Ha = r - 2, L[t] = I) : L[t].ya[r - 2] = I, [])), [];
      });
      ...
      }, toWireType: (u, h3) => h3.value, Ca: 8, readValueFromPointer: T3(t, r, a), Da: null }), q1(t, o);
    }, k: (e, t, r) => {
      var a = t2(e, "enum");
      ...
      e = D(e), e = B2(e), o = z(a, o), q1(e, function() {
        F1(`Cannot call ${e} due to unbound types`, h3);
      }, t - 1), Q([], h3, (l) => (W2(e, X1(e, [l[0], null].concat(l.slice(1)), null, o, u), t - 1), []));
    }, l: (e, t, r, a, o) => {
      if (t = D(t), o === -1 && (o = 4294967295), o = (l) => l, a === 0) {
        var u = 32 - 8 * r;
        o = (l) => l << u >>> u;
      }
      var h3 = t.includes("unsigned") ? function(l, p) {
        return p >>> 0;
      } : function(l, p) {
        return p;
      };
      H(e, { name: t, fromWireType: o, toWireType: h3, Ca: 8, readValueFromPointer: F3(t, r, a !== 0), Da: null });
    }, h: (e, t, r) => {
      function a(u) {
      ...
      H(e, A3);
    }, aa: (e, t, r, a, o, u, h3, l, p, v, f, w) => {
      r = D(r), u = z(o, u), l = z(h3, l), v = z(p, v), w = z(f, w), Q([e], [t], (L) => (L = L[0], [new g1(r, L.va, false, false, true, L, a, u, l, v, w)]));
    }, A: (e, t) => {
      t = D(t);
      var r = t === "std::string";
      H(e, { name: t, fromWireType: function(a) {
        var o = E[a >> 2], u = a + 4;
        if (r)
          for (var h3 = u, l = 0; l <= o; ++l) {
            var p = u + l;
            if (l == o || x[p] == 0) {
              if (h3 = h3 ? c1(x, h3, p - h3) : "", v === void 0)
                var v = h3;
              else
                v += "\0", v += h3;
              h3 = p + 1;
        ...
        var u, h3 = typeof o == "string";
        if (!(h3 || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array))
        ...
        if (r && h3)
          ...
          u = o.length;
        if (l = s2(4 + u + 1), p = l + 4, E[l >> 2] = u, r && h3)
          p1(o, p, u + 1);
        else if (h3)
          for (h3 = 0; h3 < u; ++h3) {
            var v = o.charCodeAt(h3);
            if (255 < v)
      ...
      if (r = D(r), t === 2)
        var a = R3, o = D3, u = k3, h3 = (l) => u1[l >> 1];
      else
        t === 4 && (a = O3, o = z3, u = W3, h3 = (l) => E[l >> 2]);
      H(e, { name: r, fromWireType: (l) => {
        for (var p = E[l >> 2], v, f = l + 4, w = 0; w <= p; ++w) {
          var L = l + 4 + w * t;
          (w == p || h3(L) == 0) && (f = a(f, L - f), v === void 0 ? v = f : (v += "\0", v += f), f = L + t);
        }
        return X(l), v;
      }, toWireType: (l, p) => {
        if (typeof p != "string")
    ...
    }, j: (e, t, r, a, o, u, h3, l, p, v) => {
      I1[e].Ra.push({ Va: D(t), $a: r, Ya: z(a, o), Za: u, gb: h3, fb: z(l, p), hb: v });
    }, X: (e, t) => {
      ...
      e--;
      var u = Array(e);
      return t = `methodCaller<(${a.map((h3) => h3.name).join(", ")}) => ${o.name}>`, $3(_1(t, (h3, l, p, v) => {
        for (var f = 0, w = 0; w < e; ++w)
          u[w] = a[w].readValueFromPointer(v + f), f += a[w].Ca;
        return l = r === 1 ? B3(l, u) : l.apply(h3, u), h3 = [], l = o.toWireType(h3, l), h3.length && (E[p >> 2] = A1(h3)), l;
      }));
    }, $: (e) => {
      9 < e && (Y[e + 1] += 1);
    }, Y: (e) => {
      ...
      o = new Date(o, 6, 1).getTimezoneOffset(), E[e >> 2] = 60 * Math.max(u, o), e1[t >> 2] = +(u != o), t = (h3) => {
        var l = Math.abs(h3);
        return `UTC${0 <= h3 ? "-" : "+"}${String(Math.floor(l / 60)).padStart(2, "0")}${String(l % 60).padStart(2, "0")}`;
      ...
      for (var o = 0, u = 0; u < r; u++) {
        var h3 = E[t >> 2], l = E[t + 4 >> 2];
        t += 8;
        for (var p = 0; p < l; p++) {
          var v = e, f = x[h3 + p], w = H3[v];
    ...
    d.dynCall_iijj = (e, t, r, a, o, u) => (d.dynCall_iijj = S.ma)(e, t, r, a, o, u), d.dynCall_vijj = (e, t, r, a, o, u) => (d.dynCall_vijj = S.na)(e, t, r, a, o, u), d.dynCall_jiii = (e, t, r, a) => (d.dynCall_jiii = S.oa)(e, t, r, a), d.dynCall_jii = (e, t, r) => (d.dynCall_jii = S.pa)(e, t, r), d.dynCall_viijii = (e, t, r, a, o, u, h3) => (d.dynCall_viijii = S.qa)(e, t, r, a, o, u, h3), d.dynCall_iiiiij = (e, t, r, a, o, u, h3) => (d.dynCall_iiiiij = S.ra)(e, t, r, a, o, u, h3), d.dynCall_iiiiijj = (e, t, r, a, o, u, h3, l, p) => (d.dynCall_iiiiijj = S.sa)(e, t, r, a, o, u, h3, l, p), d.dynCall_iiiiiijj = (e, t, r, a, o, u, h3, l, p, v) => (d.dynCall_iiiiiijj = S.ta)(e, t, r, a, o, u, h3, l, p, v);
    function J3(e, t, r) {
      var a = G();
      try {
        j.get(e)(t, r);
...
// node_modules/@lottiefiles/dotlottie-vue/dist/index.js
var DotLottieVue = defineComponent({
  ...
  setup(props, { attrs, expose }) {
    ...
    let dotLottie = null;
    watch(
      () => backgroundColor == null ? void 0 : backgroundColor.value,
      (newVal) => {
    ...
    watch(
      () => marker == null ? void 0 : marker.value,
      (newVal) => {
        if (dotLottie && typeof newVal !== "undefined") {
    ...
    watch(
      () => segment == null ? void 0 : segment.value,
      (newVal) => {
        if (!dotLottie)
          return;
        const startFrame = newVal == null ? void 0 : newVal[0];
        const endFrame = newVal == null ? void 0 : newVal[1];
    ...
    watch(
      () => useFrameInterpolation == null ? void 0 : useFrameInterpolation.value,
      (newVal) => {
        if (dotLottie && typeof newVal !== "undefined") {
    ...
    function hoverHandler(event) {
      if (event.type === "mouseenter") {
        dotLottie == null ? void 0 : dotLottie.play();
      } else {
        dotLottie == null ? void 0 : dotLottie.pause();
      }
    }
    watch(
      () => playOnHover == null ? void 0 : playOnHover.value,
      (newVal) => {
        var _a, _b, _c, _d;
        if (dotLottie && typeof newVal !== "undefined" && newVal) {
          (_a = canvas.value) == null ? void 0 : _a.addEventListener("mouseenter", hoverHandler);
          (_b = canvas.value) == null ? void 0 : _b.addEventListener("mouseleave", hoverHandler);
        } else {
          (_c = canvas.value) == null ? void 0 : _c.removeEventListener("mouseenter", hoverHandler);
          (_d = canvas.value) == null ? void 0 : _d.removeEventListener("mouseleave", hoverHandler);
        }
      }
    );
    onMounted(() => {
      ...
      if (typeof (playOnHover == null ? void 0 : playOnHover.value) !== "undefined" && playOnHover.value) {
      ...
      if (playOnHover == null ? void 0 : playOnHover.value) {
    ...
    onBeforeUnmount(() => {
      ...
      (_a = canvas.value) == null ? void 0 : _a.addEventListener("mouseenter", hoverHandler);
      (_b = canvas.value) == null ? void 0 : _b.addEventListener("mouseleave", hoverHandler);
      dotLottie == null ? void 0 : dotLottie.destroy();
    });
    expose({
...
//# sourceMappingURL=@lottiefiles_dotlottie-vue.js.map

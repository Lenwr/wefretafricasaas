import {
  ...
  getFirestore,
  onSnapshot
} from "./chunk-WXKQTGKD.js";
import "./chunk-EK7YRCVH.js";
import {
  getAuth,
  onIdTokenChanged,
  updateProfile
} from "./chunk-QYQDOLEN.js";
import {
  getDownloadURL,
  getMetadata,
  getStorage,
...
// node_modules/vuefire/dist/shared/vuefire.14b7e2d3.mjs
var _FirebaseAppInjectionKey = Symbol("firebaseApp");
function useFirebaseApp(name3) {
...
function useCurrentUser(name3) {
  if (!authUserMap.has(useFirebaseApp(name3))) {
    throw new Error(
      `[VueFire] useCurrentUser() called before the VueFireAuth module was added to the VueFire plugin. This will fail in production.`
    );
  }
  return authUserMap.get(useFirebaseApp(name3));
}
function useIsCurrentUserLoaded(name3) {
  const currentUser = useCurrentUser(name3);
...
function _getCurrentUserState(name3) {
  const firebaseApp = useFirebaseApp(name3);
...
function getCurrentUser(name3) {
  const userOrPromise = _getCurrentUserState(name3);
...
function useAppCheck(name3) {
  return AppCheckMap.get(useFirebaseApp(name3));
}
...
function useDatabase(name3) {
  return getDatabase(useFirebaseApp(name3));
}
...
function useFirestore(name3) {
  return getFirestore(useFirebaseApp(name3));
}
...
function useFirebaseAuth(name3) {
  return isClient ? getAuth(useFirebaseApp(name3)) : null;
}
function useFirebaseStorage(name3) {
  return getStorage(useFirebaseApp(name3));
}
